...
### Landing Pen
- 🛬 New players wait in a pre-game lobby until they're ready to spawn. Players in the pen have restricted permissions to prevent griefing.
- 👥 **Buddy system** - Pair up with a friend to spawn on the same planet.
- 🔧 Admins can disable the pen to spawn players directly.

### Commands
- `/st-players` - Lists all players and their surfaces with GPS pings.
